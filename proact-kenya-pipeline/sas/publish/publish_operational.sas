/*=============================================================================
  ProACT Kenya Pipeline - Publish Model (Operational)
  =============================================================================
  Purpose: Extract model scores from Denodo and publish to CAS for 
           Operational use.
  
  CAS Table: KE_model_operational
  Target: SB_model_operational (per diagram)
  =============================================================================*/

%macro publish_operational();
    ...
    %put NOTE: ========================================================;
    %put NOTE: ProACT Kenya - Publish Operational Model;
    ...
    %let DenodoView = vw_ke_proact_operational;
    ...
    %put NOTE: ========================================================;
    %put NOTE: PUBLISH COMPLETE - Operational model scores loaded;
    %put NOTE: CAS Table: &CASTableName. | CASLib: &CasLibName.;
    %put NOTE: ========================================================;

%mend publish_operational;
