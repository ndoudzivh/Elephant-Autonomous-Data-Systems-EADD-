    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="text-center max-w-3xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <a href="/signup" className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl text-lg font-medium">
            Start Building Free →
          </a>
        </div>
        <p className="text-sm text-gray-500">No credit card required. 20 messages/day free forever.</p>
        <div className="mt-16 text-gray-500 text-sm">
          Generates production code for: <span className="text-gray-300 font-medium">AWS | Azure | Snowflake | dbt | Databricks</span>
        </div>
      </div>
    </div>
  );
